...
PRODUCT_PACKAGES += \
	hciconfig \
	hcitool
# Broadcom bluetooth firmware loader
#PRODUCT_PACKAGES += \
	brcm_patchram_plus
...
PRODUCT_COPY_FILES +=	\
	...
	device/fsl/imx6/wandboard/fstab.wandboard:root/fstab.wandboard \
	device/fsl/imx6/wandboard/audio_policy.conf:system/etc/audio_policy.conf \
	device/fsl/imx6/etc/apns-conf.xml:system/etc/apns-conf.xml \
	device/fsl/imx6/etc/init.usb.rc:root/init.wandboard.usb.rc \
